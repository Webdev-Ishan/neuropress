  ...
  return (
    <FeatureCard {...props}>
      ...
      <>
        ...
        />
        <div className="absolute left-48 top-5 z-50 mb-6 size-full cursor-pointer md:left-0">
...
export function Steps({ steps, current, onChange }: StepsProps) {
  return (
    <nav aria-label="Progress" className="flex justify-center mb-4 px-4 ">
      <ol
        className="flex w-full  flex-wrap items-start justify-start gap-2 mb-18  sm:justify-center md:w-10/12 md:divide-y-0"
        role="list"
      >
        {steps.map((step, stepIdx) => {
          ...
          return (
            <li
              className={cn(
                "relative z-30 rounded-full px-3 py-1  transition-all duration-300 ease-in-out md:flex",
